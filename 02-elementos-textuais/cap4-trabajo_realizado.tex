...
\section{Implementación de Encoder}
    ...
    \label{sec:encoder-caracterizacion}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4cm]{04-figuras/encoder-out-interno.png}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4cm]{04-figuras/encoder-out-senal.png}
    ...
    \label{sec:encoder-montaje}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4cm]{04-figuras/encoder-prueba.jpg}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4cm]{04-figuras/encoder-senal.jpg}
    ...
    \label{sec:encoder-esp32}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4cm]{04-figuras/encoder-esp.jpg}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=4cm]{04-figuras/encoder-code.jpg}
...
\label{sec:driver-motor}
    ...
    El DM542T acepta entradas ópticamente aisladas para PUL, DIR y ENA; puede funcionar con niveles lógicos compatibles con 5 V cuando el aislamiento está configurado apropiadamente. En la integración con el ESP32 se utilizó la siguiente convención (ejemplo):

    \begin{itemize}
        \item PUL: recibe el tren de pulsos que hace avanzar el motor.
        \item DIR: selecciona el sentido de giro (hora/anti-hora).
        \item ENA: señal opcional para habilitar o deshabilitar el driver.
    \end{itemize}

    En el diagrama de conexiones usado (\ref{fig:montaje-conexiones-motor}) se observa la ruta desde el ESP32 a las entradas del DM542T. Es importante respetar la polaridad y los jumpers de configuración del driver (niveles y pull-ups) y emplear una masa común cuando no se usa el aislamiento óptico.

    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{04-figuras/motor-esp.jpg}
    ...
    Para controlar exactamente una vuelta del eje se debe enviar al pin PUL un número de pulsos igual al número de pasos por revolución del motor multiplicado por el factor de microstepping configurado en el DM542T.
