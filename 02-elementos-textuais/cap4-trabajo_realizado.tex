...
\section{Implementación de Encoder}
    ...
    \label{sec:encoder-esp32}
        ...
        La figura \ref{fig:encoder-esp32-montaje} muestra el montaje físico del encoder conectado al ESP32. La figura \ref{fig:encoder-esp32-salida} muestra una captura de la salida serial (ejemplo) que también es de terminal, generada por el firmware de lectura.
