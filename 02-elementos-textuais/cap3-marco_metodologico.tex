...
\begin{enumerate}[label=\textbf{Semana \arabic*:}, leftmargin=*]
    ...
    \item \textbf{Más optimización y pruebas de robustez (06/10 al 10/10):}
    Se continuó con la sintonización de las ganancias del controlador y se realizaron pruebas adicionales para evaluar la respuesta del sistema ante diferentes condiciones de carga y perturbaciones externas. Se diseñó una interfaz de usuario con múltiples vistas, gestionada por una tarea de baja prioridad, para mostrar en tiempo real el estado del sistema, el ángulo del péndulo, y las constantes del controlador, facilitando el diagnóstico y la sintonización.
