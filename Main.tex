...
%               By   Valdex Santos                %
%          Colaborador: Francisco B. S. Oliveira  %               
%            <valdexsantos@ifba.edu.br>				%
%            Mais templates em abre.ai/profwaldexsantos %       
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%========================================================
\documentclass[oneside, spanish]{pacotes/ppgmc-uesc}%CARREGANDO A CLASSE
...
% elementos textuais
    ...
    \include{./02-elementos-textuais/cap0-objetivos}		%objetivos
	\include{./02-elementos-textuais/cap2-marco_teorico}	% Elementos da dissertação/tese
	\include{./02-elementos-textuais/cap3-marco_metodologico}	% citações e referências
	\include{./02-elementos-textuais/cap4-trabajo_realizado}		% tabelas e figuras
    \include{./02-elementos-textuais/cap5-resultados} %resultados
	\include{./02-elementos-textuais/cap6-conclusion}		% Conclusão
